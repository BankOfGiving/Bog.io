    ...
    return {
        ...
        localizeView: function (container, viewName) {
            ...
            for (var i = 0; i < localizableElements.length; i++) {
                ...
                var locText = valueByString(viewText, textSrc);
                ...
                switch (textTarget) {
                    ...
                    case 'html':
                        ...
                        break;
                    case 'form-group':
                        $(element).children("label").text(locText.label);
                        if (locText.placeholder) {
                            $(element).children("div > [placeholder]").attr("placeholder", locText.placeholder);
                        }
                        break;
                }
            }
