define(['jquery', 'underscore', 'backbone', 'bog', 'lib/bog.maps/bog.maps', 'models/model.donation', 'text!../../../templates/donations/donation.form.html'],
    function ($, _, Backbone, bog, maps, DonationModel, FormTemplate) {
        /*        return Backbone.View.extend({
         ...
         //TODO:  figure out better way to handle this.  Should be passing the viewModel not the model.  Binding fails on loadFromEntity
         ...
         self.siteText = bog.i18n.getViewText('donation_edit', 'en-us');

         bog.site.setPageHeader(self.siteText.pageHeader.title, self.siteText.pageHeader.description);
