define(['jquery', 'underscore', 'backbone', 'views/maps/map.small', 'views/donations/_donation.form', 'models/model.donation', 'text!../../../templates/donations/donation.edit.html'],
