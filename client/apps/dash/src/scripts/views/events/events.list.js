define(['jquery', 'underscore', 'backbone', 'modules/bog.site', 'modules/bog.i18n', 'modules/bog.maps', 'collections/collection.events', 'text!../../../templates/events/events.list.html'],
