define(['jquery', 'underscore', 'backbone', 'bootstrap', 'moment', 'modules/bog.site', 'modules/bog.maps', 'modules/bog.i18n', 'models/model.event', 'text!../../../templates/events/event.detail.html'],
