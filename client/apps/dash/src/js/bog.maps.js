define(["async!http://maps.google.com/maps/api/js?key=AIzaSyCZjCOZHzKqlOAkBXr1HFrLtY84zVqWZxA&sensor=true!callback"], function () {
    return {
        ...
        createMarker: function (map, entity) {
            var self = this;
