define([ 'jquery', 'underscore', 'backbone', 'modules/bog.maps', 'views/maps/map.header', 'views/filters/filter.donations', 'collections/collection.donations', 'text!../../../templates/donations/list.all.html' ],
